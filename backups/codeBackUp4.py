...
def score(window, p1Name, p1Score, p2Name, p2Score, width, height):
    rectangle(window,height-3,0,height-1,width-1)
...
def main(stdscr):
    ...
    while True:
        ...
        rectangle(stdscr,height-3,0,height-1,width-8)
        stdscr.addstr(height-2, 1,"Pontuacao dos bixo",curses.A_BOLD)
        stdscr.addstr(height-2, 30,"Pontuacao dos bixo",curses.A_STANDOUT)
